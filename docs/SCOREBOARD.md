...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 192 | 102 | 34 partly | 328 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 192 done, 34 partly done (fixed, protection pending), 102 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 883 | 0 | 9 exempt | 892 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
