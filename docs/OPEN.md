...
- **Queue (this file):** 135 done, 14 partly done (fixed, protection pending), 134 open. Source of truth for work.
...
**Queue: 283 items — 135 done, 14 partly done (fixed, protection pending), 134 open.**
