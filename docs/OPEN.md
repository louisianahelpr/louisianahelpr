...
- **Queue (this file):** 64 done, 11 partly done (fixed, protection pending), 78 open. Source of truth for work.
...
**Queue: 153 items — 64 done, 11 partly done (fixed, protection pending), 78 open.**
