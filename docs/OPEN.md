...
- **Queue (this file):** 98 done, 10 partly done (fixed, protection pending), 86 open. Source of truth for work.
...
**Queue: 194 items — 98 done, 10 partly done (fixed, protection pending), 86 open.**
