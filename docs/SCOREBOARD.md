...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 255 | 112 | 44 partly | 411 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 255 done, 44 partly done (fixed, protection pending), 112 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 1051 | 3 | 9 exempt | 1063 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
