...
- **Queue (this file):** 92 done, 10 partly done (fixed, protection pending), 86 open. Source of truth for work.
...
**Queue: 188 items — 92 done, 10 partly done (fixed, protection pending), 86 open.**
