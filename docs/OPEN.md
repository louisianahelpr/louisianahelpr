...
- **Queue (this file):** 128 done, 15 partly done (fixed, protection pending), 135 open. Source of truth for work.
...
**Queue: 278 items — 128 done, 15 partly done (fixed, protection pending), 135 open.**
