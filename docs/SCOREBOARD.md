...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 240 | 112 | 34 partly | 386 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 240 done, 34 partly done (fixed, protection pending), 112 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 1025 | 0 | 9 exempt | 1034 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
