...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 32 | 70 | 4 partly | 106 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 32 done, 4 partly done (fixed, protection pending), 70 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 733 | 0 | 8 exempt | 741 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
