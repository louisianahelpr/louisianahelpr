...
>(({ className, align = "center", sideOffset = 4, collisionPadding = 12, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      // Radix's default collisionPadding is 0, so a popover wider than its
      // trigger slides until it TOUCHES the viewport edge. Measured 2026-09-07
      // at 375: the PostJob date picker at x 41→375 (flush right, no gutter)
      // and the Availability time-range picker at x 5→305. 12px keeps every
      // popover inside the same gutter the page content already keeps.
