...
/**
 * JobsHeader — the My Jobs (/jobs) header: the "My Jobs" title row with
 ...
 * page and passed in.
 *
 * My Jobs owns this header and My Posts owns its own (src/pages/posts/
 * PostsHeader.tsx). Owner, 2026-09-25: "They should be there own headers. We
 ...
 */
export const JOBS_HEADER_PADDING = "!py-1.5 lg:!py-2";

const TITLE = "My Jobs";
const TABS_ID = "jobs-status-tabs";
...
/** The filter My Jobs opens on. Read from the same function JobListPage
 *  seeds its state with, so the two can never disagree about what
 *  "unfiltered" means. */
const DEFAULT_STATUS_FILTER = defaultStatusFilterFor("applied");
