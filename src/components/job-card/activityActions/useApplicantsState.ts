...
import type { Job, EnrichedApplication } from "@/components/job-card/activityConstants";
import { applicantSignalHelperIds, prefetchApplicantSignals } from "@/pages/posts/postedJobs/useApplicantSignals";
