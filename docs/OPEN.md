...
- **Queue (this file):** 122 done, 14 partly done (fixed, protection pending), 84 open. Source of truth for work.
...
**Queue: 220 items — 122 done, 14 partly done (fixed, protection pending), 84 open.**
