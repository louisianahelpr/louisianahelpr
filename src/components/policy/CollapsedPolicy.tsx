...
export const PolicyRowItem = ({ icon: Icon, title, body, warning }: PolicyRow) => {
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <CollapsibleTrigger className={`group w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-ds-md text-left transition-colors btn-press ${warning ? "hover:bg-destructive/10" : "hover:bg-primary/5"}`}>
