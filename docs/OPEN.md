...
- **Queue (this file):** 140 done, 22 partly done (fixed, protection pending), 133 open. Source of truth for work.
...
**Queue: 295 items — 140 done, 22 partly done (fixed, protection pending), 133 open.**
