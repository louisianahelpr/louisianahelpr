...
**117 files render form controls, across 22 route groups.** Primitives in `src/components/ui/` are excluded. Messy-input coverage: `e2e/prod-audit/messy-input.spec.ts` (PROD, no mocks).
