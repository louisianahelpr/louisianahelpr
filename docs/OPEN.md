...
- **Queue (this file):** 145 done, 22 partly done (fixed, protection pending), 128 open. Source of truth for work.
...
**Queue: 295 items — 145 done, 22 partly done (fixed, protection pending), 128 open.**
