...
INSERT INTO q140_class (fn, kind, why) VALUES
  ...
  ('get_thread_counterparty_deleted', 'classify', 'labels a thread''s other party as a deleted account (read-only notice); grants nothing, and a NULL argument returns false (threadCounterpartyDeleted.pglite.mjs)'),
