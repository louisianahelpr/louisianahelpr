...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 250 | 120 | 34 partly | 404 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 250 done, 34 partly done (fixed, protection pending), 120 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 1041 | 0 | 10 exempt | 1051 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
