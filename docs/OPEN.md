...
- **Queue (this file):** 142 done, 22 partly done (fixed, protection pending), 131 open. Source of truth for work.
...
**Queue: 295 items — 142 done, 22 partly done (fixed, protection pending), 131 open.**
