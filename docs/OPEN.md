...
- **Queue (this file):** 50 done, 5 partly done (fixed, protection pending), 72 open. Source of truth for work.
...
**Queue: 127 items — 50 done, 5 partly done (fixed, protection pending), 72 open.**
