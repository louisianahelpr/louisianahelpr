...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden flex flex-col justify-center items-center min-h-[calc(100svh-6rem)] lg:min-h-[calc(100svh-22rem)] px-5 sm:px-8 lg:px-12 pt-28 sm:pt-32 lg:pt-24 pb-3 sm:pb-4 lg:pb-6">
      ...
      <div className="relative z-10 w-full mx-auto max-w-5xl flex flex-col items-center text-center gap-8 sm:gap-10 lg:gap-12">
        ...
        <div className="relative flex items-center justify-center w-full">
          ...
          <h1
            ref={headlineRef}
            className="relative z-10 font-display font-black leading-[0.98] text-balance break-words text-[3.5rem] sm:text-[5rem] md:text-[6.5rem] lg:text-[6rem] xl:text-[7rem] hero-h1-settle"
            style={{
