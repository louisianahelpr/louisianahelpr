...
- **Queue (this file):** 107 done, 10 partly done (fixed, protection pending), 87 open. Source of truth for work.
...
**Queue: 204 items — 107 done, 10 partly done (fixed, protection pending), 87 open.**
