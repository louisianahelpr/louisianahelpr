...
- **Queue (this file):** 109 done, 11 partly done (fixed, protection pending), 85 open. Source of truth for work.
...
**Queue: 205 items — 109 done, 11 partly done (fixed, protection pending), 85 open.**
