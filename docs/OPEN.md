...
- **Queue (this file):** 114 done, 11 partly done (fixed, protection pending), 88 open. Source of truth for work.
...
**Queue: 213 items — 114 done, 11 partly done (fixed, protection pending), 88 open.**
