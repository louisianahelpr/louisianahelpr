...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 153 | 127 | 26 partly | 306 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 153 done, 26 partly done (fixed, protection pending), 127 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 844 | 1 | 9 exempt | 854 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
