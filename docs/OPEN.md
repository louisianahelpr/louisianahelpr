...
- **Queue (this file):** 46 done, 5 partly done (fixed, protection pending), 70 open. Source of truth for work.
...
**Queue: 121 items — 46 done, 5 partly done (fixed, protection pending), 70 open.**
