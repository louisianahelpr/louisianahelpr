...
// @mutate src/pages/auth/completeProfile/uploadProfileFiles.ts | return { saved: await saveRow({ avatarUrl: null }), staleAvatarObjects: [] }; | return { saved: await saveRow({ avatarUrl: null }), staleAvatarObjects: ["x"] };
