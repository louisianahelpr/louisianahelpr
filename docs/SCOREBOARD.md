...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 51 | 75 | 6 partly | 132 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 51 done, 6 partly done (fixed, protection pending), 75 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 745 | 0 | 8 exempt | 753 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
