...
// @mutate src/components/job-card/JobCardMetaRow.tsx | px-1 -mx-1 rounded-ds-sm hover:bg- | px-1 -mx-1 rounded-ds-sm border border-[hsl(var(--olivewood)/0.18)] bg-[hsl(var(--olivewood)/0.06)] hover:bg-
//
...
// @mutate src/components/job-card/JobCardMetaRow.tsx | rounded-ds-sm hover:bg- | rounded-ds-sm border-2 border-olivewood hover:bg-
// @mutate src/components/job-card/JobCardMetaRow.tsx | hold for the map`} | hold for the map`} style={{ background: "hsl(var(--olivewood) / 0.06)" }}
