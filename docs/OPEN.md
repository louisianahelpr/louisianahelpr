...
- **Queue (this file):** 128 done, 12 partly done (fixed, protection pending), 129 open. Source of truth for work.
...
**Queue: 269 items — 128 done, 12 partly done (fixed, protection pending), 129 open.**
