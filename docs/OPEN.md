...
- **Queue (this file):** 53 done, 6 partly done (fixed, protection pending), 74 open. Source of truth for work.
...
**Queue: 133 items — 53 done, 6 partly done (fixed, protection pending), 74 open.**
