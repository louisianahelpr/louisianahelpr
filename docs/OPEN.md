...
- **Queue (this file):** 47 done, 5 partly done (fixed, protection pending), 69 open. Source of truth for work.
...
**Queue: 121 items — 47 done, 5 partly done (fixed, protection pending), 69 open.**
