...
- **Queue (this file):** 75 done, 11 partly done (fixed, protection pending), 75 open. Source of truth for work.
...
**Queue: 161 items — 75 done, 11 partly done (fixed, protection pending), 75 open.**
