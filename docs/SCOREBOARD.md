...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 120 | 82 | 13 partly | 215 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 120 done, 13 partly done (fixed, protection pending), 82 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 798 | 0 | 8 exempt | 806 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
