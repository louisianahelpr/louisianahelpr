...
- **Queue (this file):** 140 done, 23 partly done (fixed, protection pending), 137 open. Source of truth for work.
...
**Queue: 300 items — 140 done, 23 partly done (fixed, protection pending), 137 open.**
