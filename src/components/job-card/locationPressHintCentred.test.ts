...
const src = readFileSync(resolve(__dirname, "../../pages/posts/PostedJobsTab.tsx"), "utf8");
...
// @mutate src/pages/posts/PostedJobsTab.tsx | flex items-center gap-2 rounded-ds-md px-3 py-2 | flex items-start gap-2 rounded-ds-md px-3 py-2
