...
- **Queue (this file):** 139 done, 19 partly done (fixed, protection pending), 132 open. Source of truth for work.
...
**Queue: 290 items — 139 done, 19 partly done (fixed, protection pending), 132 open.**
