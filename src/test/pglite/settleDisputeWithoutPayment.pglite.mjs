#!/usr/bin/env node
/**
 * PGlite proof for 20260923205812_settle_dispute_without_payment
 * (docs/OPEN.md Q235).
 *
...
const MIG = fileURLToPath(new URL("../../../supabase/migrations/20260923205812_settle_dispute_without_payment.sql", import.meta.url));
