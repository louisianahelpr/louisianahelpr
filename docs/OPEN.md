...
- **Queue (this file):** 104 done, 10 partly done (fixed, protection pending), 90 open. Source of truth for work.
...
**Queue: 204 items — 104 done, 10 partly done (fixed, protection pending), 90 open.**
