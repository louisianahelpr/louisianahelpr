...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 103 | 91 | 10 partly | 204 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 103 done, 10 partly done (fixed, protection pending), 91 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 776 | 1 | 8 exempt | 785 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
