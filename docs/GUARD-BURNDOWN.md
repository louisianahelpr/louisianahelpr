...
|---|---|---|---|---|
| **`src/test/*.test.ts*`** | 437 | **437 — COMPLETE** | 0 | **0** |
| **`src/test/edge/` (money)** | 67 | **67 — COMPLETE** | 0 | **0** |
| **colocated beside components** | 363 | **363 — COMPLETE** | 0 | **0** |
| **Playwright `e2e/`** | 67 | **58 — COMPLETE** | 9 | **0** |
| **total** | **934** | **925 (99%)** | **9** | **0** |

`npm run vacuity` prints the same three numbers on every run:

```
registration: 925/934 guards register a mutation (9 exempt with a reason, 0 grandfathered)
```
