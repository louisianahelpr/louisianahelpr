...
- **Queue (this file):** 116 done, 12 partly done (fixed, protection pending), 86 open. Source of truth for work.
...
**Queue: 214 items — 116 done, 12 partly done (fixed, protection pending), 86 open.**
