...
- **Queue (this file):** 47 done, 5 partly done (fixed, protection pending), 70 open. Source of truth for work.
...
**Queue: 122 items — 47 done, 5 partly done (fixed, protection pending), 70 open.**
