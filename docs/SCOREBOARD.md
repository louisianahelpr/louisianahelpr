...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 148 | 124 | 30 partly | 302 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 148 done, 30 partly done (fixed, protection pending), 124 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 842 | 0 | 9 exempt | 851 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
