...
- **Queue (this file):** 105 done, 10 partly done (fixed, protection pending), 89 open. Source of truth for work.
...
**Queue: 204 items — 105 done, 10 partly done (fixed, protection pending), 89 open.**
