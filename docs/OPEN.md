...
- **Queue (this file):** 110 done, 12 partly done (fixed, protection pending), 86 open. Source of truth for work.
...
**Queue: 208 items — 110 done, 12 partly done (fixed, protection pending), 86 open.**
