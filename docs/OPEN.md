...
- **Queue (this file):** 146 done, 24 partly done (fixed, protection pending), 127 open. Source of truth for work.
...
**Queue: 297 items — 146 done, 24 partly done (fixed, protection pending), 127 open.**
