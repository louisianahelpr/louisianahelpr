...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 155 | 121 | 32 partly | 308 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 155 done, 32 partly done (fixed, protection pending), 121 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 851 | 1 | 9 exempt | 861 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
