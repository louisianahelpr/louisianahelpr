      ...
      <>
        ...
        >
          {loading ? (
            ...
            <div
              className="flex items-center justify-center w-48 h-32 font-sans text-ds-12"
  ...
  if (isPdfMime(mime)) {
    ...
    return (
      ...
      >
        ...
        <span title={filename} className="truncate max-w-[180px] font-sans font-semibold text-ds-12">{filename}</span>
