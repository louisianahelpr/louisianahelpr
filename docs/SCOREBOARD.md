...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 18 | 64 | 4 partly | 86 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 18 done, 4 partly done (fixed, protection pending), 64 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 722 | 0 | 8 exempt | 730 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
