...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 w-full min-w-0 grid grid-rows-[auto_1fr] md:grid-rows-1 md:grid-cols-2 items-stretch pb-4 sm:pb-6 md:pb-14">
        {/* LEFT: copy + CTAs — vertically centered against image, bottom aligned to image bottom */}
        <div
          className="min-w-0 max-w-full animate-fade-in px-6 sm:px-10 md:pl-12 lg:pl-24 xl:pl-32 md:pr-8 text-center md:text-left md:pt-0 flex flex-col md:justify-center"
          style={{
            paddingLeft: "max(1.5rem, env(safe-area-inset-left))",
          }}
        >
          <div className="w-full max-w-2xl mx-auto md:mx-0 flex flex-col gap-4 sm:gap-5 md:gap-8">
            ...
            <div className="flex flex-col gap-3 sm:gap-4 md:gap-8">
              ...
              {/* Subhead */}
              <p className="text-base sm:text-lg text-foreground/75 font-medium leading-snug max-w-xl mx-auto md:mx-0 lg:text-xl font-sans">
            ...
            <div className="flex flex-col items-stretch gap-3 lg:gap-4 w-full max-w-md md:max-w-xl mx-auto md:mx-0">
              <Button
                size="xl"
