...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 128 | 129 | 12 partly | 269 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 128 done, 12 partly done (fixed, protection pending), 129 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 806 | 0 | 9 exempt | 815 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
