...
const faqs = [
  {
    ...
    a: "Every helper completes Stripe Identity verification — a government ID check — before being activated. You also see their ratings, reviews, and how many jobs they've completed for other Louisiana neighbors — all before you choose.",
  },
  {
