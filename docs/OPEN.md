...
- **Queue (this file):** 144 done, 22 partly done (fixed, protection pending), 129 open. Source of truth for work.
...
**Queue: 295 items — 144 done, 22 partly done (fixed, protection pending), 129 open.**
