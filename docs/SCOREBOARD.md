...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 54 | 75 | 6 partly | 135 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 54 done, 6 partly done (fixed, protection pending), 75 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 747 | 0 | 8 exempt | 755 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
