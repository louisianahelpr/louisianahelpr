...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 50 | 73 | 5 partly | 128 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 50 done, 5 partly done (fixed, protection pending), 73 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 743 | 0 | 8 exempt | 751 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
