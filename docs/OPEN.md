...
- **Queue (this file):** 100 done, 10 partly done (fixed, protection pending), 88 open. Source of truth for work.
...
**Queue: 198 items — 100 done, 10 partly done (fixed, protection pending), 88 open.**
