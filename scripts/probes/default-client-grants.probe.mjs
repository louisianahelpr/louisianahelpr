// Probe: 20260915051534 (no default client grants in public) and the class
...
const MIG = read("../../supabase/migrations/20260915051534_no_default_client_grants.sql");
...
{
  console.log("\n== 2. AFTER (20260915051534 applied 3x)");
