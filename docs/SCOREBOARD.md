...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 128 | 135 | 15 partly | 278 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 128 done, 15 partly done (fixed, protection pending), 135 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 815 | 0 | 9 exempt | 824 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
