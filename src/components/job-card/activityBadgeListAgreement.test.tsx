...
vi.mock("@/pages/jobs/appliedJobCard/PendingApplicationSection", () => ({ PendingApplicationSection: () => <div data-testid="pending" /> }));
vi.mock("@/pages/jobs/appliedJobCard/OfferedActions", () => ({ OfferedActions: () => <div data-testid="offered" /> }));
vi.mock("@/pages/jobs/appliedJobCard/ConfirmedSection", () => ({ ConfirmedSection: () => <div data-testid="confirmed" /> }));
vi.mock("@/pages/jobs/appliedJobCard/ActiveJobSection", () => ({ ActiveJobSection: () => <div data-testid="active" /> }));
vi.mock("@/pages/jobs/appliedJobCard/DisputedSection", () => ({ DisputedSection: () => <div data-testid="disputed" /> }));
