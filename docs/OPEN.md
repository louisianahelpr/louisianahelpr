...
- **Queue (this file):** 137 done, 13 partly done (fixed, protection pending), 135 open. Source of truth for work.
...
**Queue: 285 items — 137 done, 13 partly done (fixed, protection pending), 135 open.**
