...
vi.mock("@/components/job-card/DeadlineCountdown", () => ({ default: () => null }));
...
// @mutate src/pages/jobs/appliedJobCard/DisputedSection.tsx | initialTracking={initialTracking} readOnly /> | initialTracking={initialTracking} />
