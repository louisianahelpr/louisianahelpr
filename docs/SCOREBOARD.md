...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 126 | 125 | 14 partly | 265 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 126 done, 14 partly done (fixed, protection pending), 125 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 801 | 0 | 8 exempt | 809 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
