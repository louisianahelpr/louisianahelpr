...
- **Queue (this file):** 146 done, 25 partly done (fixed, protection pending), 130 open. Source of truth for work.
...
**Queue: 301 items — 146 done, 25 partly done (fixed, protection pending), 130 open.**
