...
- **Queue (this file):** 73 done, 11 partly done (fixed, protection pending), 76 open. Source of truth for work.
...
**Queue: 160 items — 73 done, 11 partly done (fixed, protection pending), 76 open.**
