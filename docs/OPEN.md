...
- **Queue (this file):** 65 done, 11 partly done (fixed, protection pending), 83 open. Source of truth for work.
...
**Queue: 160 items — 65 done, 11 partly done (fixed, protection pending), 84 open.**
