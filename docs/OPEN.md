...
- **Queue (this file):** 121 done, 11 partly done (fixed, protection pending), 88 open. Source of truth for work.
...
**Queue: 220 items — 121 done, 11 partly done (fixed, protection pending), 88 open.**
