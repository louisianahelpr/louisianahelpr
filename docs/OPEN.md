...
- **Queue (this file):** 55 done, 7 partly done (fixed, protection pending), 89 open. Source of truth for work.
...
**Queue: 151 items — 55 done, 7 partly done (fixed, protection pending), 89 open.**
