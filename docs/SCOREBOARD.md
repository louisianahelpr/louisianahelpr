...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 1047 | 1 | 9 exempt | 1057 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
