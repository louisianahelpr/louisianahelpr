...
- **Queue (this file):** 151 done, 27 partly done (fixed, protection pending), 127 open. Source of truth for work.
...
**Queue: 305 items — 151 done, 27 partly done (fixed, protection pending), 127 open.**
...
- [ ] **Q227 The CSS-minifier lesson prescribes grep -c, which counts LINES of a one-line bundle and cannot tell the two states apart. (Q165 carry-over, 2026-09-23.)** Evidence: docs/lessons/CLAUDE-lessons.md:246; use grep -o ... | wc -l. From: docs/archive/launch-2026-09/VERIFIED_REPORT.md.
