...
- **Queue (this file):** 255 done, 33 partly done (fixed, protection pending), 112 open. Source of truth for work.
...
**Queue: 400 items — 255 done, 33 partly done (fixed, protection pending), 112 open.**
