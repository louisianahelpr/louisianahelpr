...
- **Queue (this file):** 120 done, 14 partly done (fixed, protection pending), 85 open. Source of truth for work.
...
**Queue: 219 items — 120 done, 14 partly done (fixed, protection pending), 85 open.**
...
- [~] **Q94 The user-error-screen close rule has no synthetic half (Q39 follow-up). BUILT on branch cloud/q94-q128-q132 (2026-09-23); live half pending (merge -> db-deploy -> a press run).**
  Migration 20260923171400_ops_route_probe_close_rule: table
  ...
  only. `ops_alert_condition` restated from its NEWEST body (20260923133021)
