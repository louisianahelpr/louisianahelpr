...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 147 | 125 | 31 partly | 303 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 147 done, 31 partly done (fixed, protection pending), 125 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 840 | 0 | 9 exempt | 849 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
