...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 44 | 70 | 5 partly | 119 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 44 done, 5 partly done (fixed, protection pending), 70 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 739 | 0 | 8 exempt | 747 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
