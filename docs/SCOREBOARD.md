...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 120 | 85 | 14 partly | 219 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 120 done, 14 partly done (fixed, protection pending), 85 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 799 | 0 | 8 exempt | 807 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
