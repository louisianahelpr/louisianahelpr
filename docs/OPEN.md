...
- **Queue (this file):** 76 done, 11 partly done (fixed, protection pending), 76 open. Source of truth for work.
...
**Queue: 163 items — 76 done, 11 partly done (fixed, protection pending), 76 open.**
