...
const HowItWorksSection = () => (
  <section
    id="how-it-works"
    className="px-5 sm:px-8 lg:px-12 py-16 sm:py-24 lg:py-28 scroll-mt-24"
  >
        ...
        {STEPS.map((step, i) => {
          ...
          return (
            <div key={step.title} className="text-center">
              ...
              <h3
                className="mt-2 font-display font-bold text-ds-20 sm:text-ds-24 tracking-tight leading-tight"
