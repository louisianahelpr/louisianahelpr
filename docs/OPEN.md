...
- **Queue (this file):** 133 done, 14 partly done (fixed, protection pending), 134 open. Source of truth for work.
...
**Queue: 281 items — 133 done, 14 partly done (fixed, protection pending), 134 open.**
