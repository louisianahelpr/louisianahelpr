    ...
    <div className="space-y-8">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center">
          <span className="bg-background px-4 text-xs font-medium text-muted-foreground uppercase tracking-wider">Subscription</span>
        </div>
      </div>
      ...
      {isHelper && (
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-display font-bold text-foreground">Helpr Subscription Plans</h2>
              <p className="text-xs text-muted-foreground">Boost your profile and get early access to jobs</p>
            </div>
          </div>
