...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 64 | 78 | 11 partly | 153 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 64 done, 11 partly done (fixed, protection pending), 78 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 753 | 0 | 8 exempt | 761 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
