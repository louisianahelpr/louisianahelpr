 ...
 *
 * @mutate src/components/activity/JobCardMetaRow.tsx | const fullAddress = showFullAddress && hasStreetAddress(location); | const fullAddress = showFullAddress;
 * @mutate src/components/activity/appliedJobCard/JobAddressLine.tsx | return /\d/.test(first) && (location ?? "").includes(","); | return (location ?? "").includes(",");
 */
