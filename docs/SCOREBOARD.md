...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 93 | 87 | 10 partly | 190 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 93 done, 10 partly done (fixed, protection pending), 87 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 769 | 0 | 8 exempt | 777 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
