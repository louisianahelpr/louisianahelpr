...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 119 | 85 | 11 partly | 215 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 119 done, 11 partly done (fixed, protection pending), 85 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 794 | 0 | 8 exempt | 802 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
