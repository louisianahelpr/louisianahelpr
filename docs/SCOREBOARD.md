...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 102 | 89 | 10 partly | 201 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 102 done, 10 partly done (fixed, protection pending), 89 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 777 | 0 | 8 exempt | 785 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
