...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 191 | 103 | 33 partly | 327 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 191 done, 33 partly done (fixed, protection pending), 103 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 881 | 0 | 9 exempt | 890 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
