...
// @mutate src/pages/jobs/appliedJobCard/steps/HelperPhotoAsk.tsx | void queryClient.invalidateQueries({ queryKey: queryKeys.activity.all }); | void 0;
// A poster who turned photo proof off must not be asked.
// @mutate src/pages/jobs/appliedJobCard/steps/HelperPhotoAsk.tsx | if (!proofRequired) return null; | if (false) return null;
