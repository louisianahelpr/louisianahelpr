...
BEGIN
  ...
  UPDATE public.cron_work_expectations c
    ...
    FROM (VALUES
      ...
      ('payment-confirm-reminder',        NULL::interval, NULL::text[], 'candidates', NULL::text),
      ('expiring-jobs-push',              NULL, NULL, 'candidates', NULL),
      ('daily-match-digest',              NULL, NULL, 'candidates', NULL),
      ('charge-recurring-visits',         NULL, NULL, 'candidates', NULL),
      ('auto-tip-charge',                 NULL, NULL, 'candidates', NULL),
      ('expire-subscriptions',            NULL, NULL, 'candidates', NULL),
      ('subscription-reconciliation',     NULL, NULL, 'candidates', NULL),
      ('marketing-publish',               NULL, NULL, 'candidates', NULL),
      ('marketing-token-health',          NULL, NULL, 'candidates', NULL),

      -- Idle rules: inflow the system makes itself, every hour of every day.
      -- work_visibility comes AFTER max_idle and work_keys on purpose: other
      -- guards read ('<job>', '<word>' ... as a cron schedule
      -- (instantPayoutReapLatencyCopy.test.ts) or, followed by an ARRAY, as a
      -- candidate_key rule (cronWatcherKeyContract.test.ts).
      ('prune-cron-run-details',          interval '3 days', ARRAY['result'], 'idle',
       NULL),
      ('prune-cron-http-requests',        interval '1 day', ARRAY['result'], 'idle',
       NULL),
      ('sweep-silent-cron-failures',      interval '6 hours', ARRAY['recorded'], 'idle',
       NULL),
      ('cron-missed-slot-catch-up',       interval '2 hours', ARRAY['succeeded_15m'], 'idle',
       NULL),

      -- Event-driven work loops: zero is the right answer whenever nothing is
      -- due, and each candidate is either counted or filed.
      ('auto-start-due-jobs',             NULL, NULL, 'exempt',
      ...
      ('sweep-daily-job-digest',          NULL, NULL, 'exempt',
      ...
      ('sweep-dayof-confirm-reminders',   NULL, NULL, 'exempt',
      ...
      ('sweep-expired-auto-bans',         NULL, NULL, 'exempt',
      ...
      ('sweep-job-start-reminders',       NULL, NULL, 'exempt',
      ...
      ('sweep-no-show-alerts',            NULL, NULL, 'exempt',
      ...
      ('sweep-release-last-chance',       NULL, NULL, 'exempt',
      ...
      ('saved-search-alert-queue',        NULL, NULL, 'exempt',
      ...
      ('reap-stranded-instant-payouts',   NULL, NULL, 'exempt',
      ...
      ('detect-suspicious-user-patterns', NULL, NULL, 'exempt',
      ...
      ('push-token-health',               NULL, NULL, 'exempt',
      ...
      ('cleanup-observability-tables',    NULL, NULL, 'exempt',
      ...
      ('cleanup-stripe-webhook-events',   NULL, NULL, 'exempt',
      ...
      ('prune-cron-run-log',              NULL, NULL, 'exempt',
      ...
      ('cleanup-notifications',           NULL, NULL, 'exempt',
      ...
      ('arrival-confirm-reminder',        NULL, NULL, 'exempt',
      ...
      ('stalled-completion-reminder',     NULL, NULL, 'exempt',
      ...
      ('backfill-job-geocode',            NULL, NULL, 'exempt',
      ...
      ('process-scheduled-payouts',       NULL, NULL, 'exempt',
      ...
      ('engagement-automations',          NULL, NULL, 'exempt',
      ...
      ('process-email-queue',             NULL, NULL, 'exempt',
      ...
      ('review-nag-cron',                 NULL, NULL, 'exempt',
      ...
      ('weekly-helper-report',            NULL, NULL, 'exempt',
      ...
      ('extend-boosts-hourly',            NULL, NULL, 'exempt',
