...
- **Queue (this file):** 128 done, 13 partly done (fixed, protection pending), 129 open. Source of truth for work.
...
**Queue: 270 items — 128 done, 13 partly done (fixed, protection pending), 129 open.**
