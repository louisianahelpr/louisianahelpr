...
// @mutate src/pages/home/DashboardGuest.tsx | useArrivalGate(phase === "ready" \|\| phase === "error", enrichmentSettled) | useArrivalGate(phase === "ready" \|\| phase === "error", enrichmentSettled, 60_000)
