...
- **Queue (this file):** 106 done, 10 partly done (fixed, protection pending), 88 open. Source of truth for work.
...
**Queue: 204 items — 106 done, 10 partly done (fixed, protection pending), 88 open.**
