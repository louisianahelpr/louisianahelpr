...
- **Queue (this file):** 180 done, 34 partly done (fixed, protection pending), 105 open. Source of truth for work.
...
**Queue: 320 items — 183 done, 32 partly done (fixed, protection pending), 105 open.**
...
- [ ] **Q259 Dashboard mount logs React "Cannot update a component while rendering" and Radix Select uncontrolled-to-controlled x3. (Q165 carry-over, 2026-09-23.)** Evidence: needs live check: open /dashboard at 375 and read the console. From: docs/archive/FABLE-LEAD-2026-08-23.md.
- [ ] **Q260 Returning users hit 404 on Browse Jobs / Login, then it refreshes in (service-worker suspect). (Q165 carry-over, 2026-09-23.)** Evidence: needs live check: returning session on an old service worker, navigate to /browse and /login (vite.config.ts:310-332 navigateFallback + NetworkFirst). From: docs/archive/FABLE-LEAD-2026-08-23.md.
...
- [ ] **Q262 public.messages sender_id / receiver_id have no foreign key. (Q165 carry-over, 2026-09-23.)** Evidence: no migration defines one (grep supabase/migrations). Needs live check: pg_constraint on public.messages, and a dirty-row audit before adding FKs. From: docs/archive/OVERNIGHT-2026-08-18.md.
