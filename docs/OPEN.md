...
- **Queue (this file):** 127 done, 13 partly done (fixed, protection pending), 132 open. Source of truth for work.
...
**Queue: 272 items — 127 done, 13 partly done (fixed, protection pending), 132 open.**
