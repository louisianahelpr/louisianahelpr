...
//
// @mutate src/pages/post-job/useJobSubmit.ts | ...(withExtras ? { client_request_id: attempt.key } : {}), | ...({}),
// @mutate src/pages/post-job/useJobSubmit.ts | if (error && (error as { code?: string }).code === "23505") { | if (false) {
