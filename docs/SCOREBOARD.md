...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 186 | 104 | 34 partly | 324 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 186 done, 34 partly done (fixed, protection pending), 104 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 877 | 0 | 9 exempt | 886 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
