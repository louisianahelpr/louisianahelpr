...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 84 | 80 | 11 partly | 175 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 84 done, 11 partly done (fixed, protection pending), 80 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 764 | 0 | 8 exempt | 772 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
