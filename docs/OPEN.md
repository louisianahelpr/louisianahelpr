...
- **Queue (this file):** 255 done, 35 partly done (fixed, protection pending), 111 open. Source of truth for work.
...
**Queue: 401 items — 255 done, 35 partly done (fixed, protection pending), 111 open.**
