...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 80 | 76 | 11 partly | 167 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 80 done, 11 partly done (fixed, protection pending), 76 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 762 | 0 | 8 exempt | 770 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
