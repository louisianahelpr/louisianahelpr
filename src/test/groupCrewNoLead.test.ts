...
const SINGLE_HELPER_ONLY: Record<string, string> = {
  block_user_and_settle: "settles a block against the single hired Helpr; a crew has none (Q709: crew block settlement)",
  ...
  get_helper_parish_badges: "counts single-helper jobs toward a badge (Q709: crew jobs in badge counts)",
  ...
  save_weekly_availability: "reads the caller's own single-helper bookings (Q709: crew bookings in availability)",
