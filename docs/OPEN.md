...
- **Queue (this file):** 107 done, 11 partly done (fixed, protection pending), 86 open. Source of truth for work.
...
**Queue: 204 items — 107 done, 11 partly done (fixed, protection pending), 86 open.**
