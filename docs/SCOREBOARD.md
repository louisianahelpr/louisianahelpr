...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 38 | 72 | 5 partly | 115 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 38 done, 5 partly done (fixed, protection pending), 72 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 737 | 0 | 8 exempt | 745 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
