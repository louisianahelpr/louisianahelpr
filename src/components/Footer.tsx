...
const Footer = () => (
  <footer className="border-t border-border py-12 px-4">
    <div className="container mx-auto space-y-8">
      ...
      {/* App Store + Facebook actions — directly above copyright */}
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 border-t border-border/50 pt-6">
        <a
          href={APP_STORE_URL}
          target="_blank"
