...
- **Queue (this file):** 138 done, 13 partly done (fixed, protection pending), 134 open. Source of truth for work.
...
**Queue: 285 items — 138 done, 13 partly done (fixed, protection pending), 134 open.**
