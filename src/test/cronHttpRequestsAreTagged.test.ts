 ...
 *
 * @mutate supabase/migrations/20260926040011_ops_alert_pending_watchdog.sql |   ELSIF p_source = 'cron-http-untagged' AND v_job IS NOT NULL THEN |   ELSIF p_source = 'cron-http-untagged-gone' AND v_job IS NOT NULL THEN
 * @mutate supabase/migrations/20260926040011_ops_alert_pending_watchdog.sql |          AND j.active\n |          AND true\n
 * @mutate supabase/migrations/20260926040011_ops_alert_pending_watchdog.sql |          AND j.command NOT LIKE '%cron_http_tag(%'); |          AND true);
 *
