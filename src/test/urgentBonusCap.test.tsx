 ...
 * @mutate supabase/migrations/20260923175412_urgent_bonus_cap_250.sql | CHECK (urgent_fee IS NULL OR (urgent_fee >= 0 AND urgent_fee <= 250)) NOT VALID; | CHECK (urgent_fee IS NULL OR (urgent_fee >= 0 AND urgent_fee <= 1000)) NOT VALID;
 * @mutate supabase/migrations/20260923175412_urgent_bonus_cap_250.sql |   ALTER TABLE public.jobs VALIDATE CONSTRAINT jobs_urgent_fee_ceiling; |   NULL;
