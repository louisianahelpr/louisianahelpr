        ...
        <div className="rounded-2xl bg-primary px-5 py-10 text-center sm:px-10 sm:py-14">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a
              ...
              className="group inline-flex min-h-14 items-center justify-center gap-3 rounded-2xl bg-foreground px-7 py-3.5 text-background shadow-[0_10px_30px_-10px_hsl(var(--foreground)/0.5)] ring-1 ring-foreground/10 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_18px_40px_-12px_hsl(var(--foreground)/0.6)]"
            ...
            <a
              ...
              className="group inline-flex min-h-14 items-center justify-center gap-3 rounded-2xl bg-primary-foreground/10 px-7 py-3.5 text-primary-foreground ring-1 ring-primary-foreground/20 backdrop-blur transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-primary-foreground/20"
            >
