...
- **Queue (this file):** 131 done, 14 partly done (fixed, protection pending), 134 open. Source of truth for work.
...
**Queue: 279 items — 131 done, 14 partly done (fixed, protection pending), 134 open.**
