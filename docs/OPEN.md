...
- **Queue (this file):** 96 done, 10 partly done (fixed, protection pending), 88 open. Source of truth for work.
...
**Queue: 194 items — 96 done, 10 partly done (fixed, protection pending), 88 open.**
