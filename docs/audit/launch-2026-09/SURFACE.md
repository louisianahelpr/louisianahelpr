...
| Toast messages | **call site** | 549 (across 137 files; itemised with their copy in `docs/audit/toast-inventory.json`) |
...
| **Copy surfaces** (strings a person may read) | mixed | **586** |
| **Total auditable surface** | mixed | **1032** |
