...
- **Queue (this file):** 50 done, 5 partly done (fixed, protection pending), 73 open. Source of truth for work.
...
**Queue: 128 items — 50 done, 5 partly done (fixed, protection pending), 73 open.**
