...
/* eslint-disable @typescript-eslint/no-explicit-any -- `ComponentType<any>` is
   what React's own `lazy()` constrains to; narrowing it to `never` or
   `unknown` makes every real page component unassignable. */
