...
- **Queue (this file):** 120 done, 13 partly done (fixed, protection pending), 82 open. Source of truth for work.
...
**Queue: 215 items — 120 done, 13 partly done (fixed, protection pending), 82 open.**
