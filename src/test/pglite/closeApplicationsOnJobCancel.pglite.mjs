#!/usr/bin/env node
/**
 * PGlite proof for 20260923185622_close_pending_applications_on_job_cancel
 * (docs/OPEN.md Q274).
 *
...
const mig = readFileSync(repo + "20260923185622_close_pending_applications_on_job_cancel.sql", "utf8");
