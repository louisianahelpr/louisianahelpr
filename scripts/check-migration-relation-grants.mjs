#!/usr/bin/env node
/**
 * A table or view created by a migration newer than 20260915051534 must grant
 * its own privileges, and a table must enable RLS, in that same migration.
 *
 * Why (2026-09-15). Until 20260915051534 prod's default privileges gave anon
...
export const CUTOFF = "20260915051534";
