...
// @mutate .github/workflows/e2e-journeys.yml |     concurrency:\n      group: prod-lifecycle-shared-accounts | concurrency:\n      group: e2e-journeys-own
// @mutate .github/workflows/e2e-real-backend.yml |     concurrency:\n      group: prod-lifecycle-shared-accounts\n      cancel-in-progress: false\n    steps:\n      - uses: actions/checkout@v7\n      - uses: actions/setup-node@v7\n        with:\n          node-version: "22"\n          cache: "npm"\n      - name: Drop the Google Chrome apt source | #\n    steps:\n      - uses: actions/checkout@v7\n      - uses: actions/setup-node@v7\n        with:\n          node-version: "22"\n          cache: "npm"\n      - name: Drop the Google Chrome apt source
