...
- **Queue (this file):** 154 done, 28 partly done (fixed, protection pending), 125 open. Source of truth for work.
...
**Queue: 307 items — 154 done, 28 partly done (fixed, protection pending), 125 open.**
