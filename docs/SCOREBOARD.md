...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 223 | 102 | 27 partly | 352 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 223 done, 27 partly done (fixed, protection pending), 102 open |
| open work | audit bus findings (open / launch blockers) | **FAIL** | 227 | 138 | — | 429 | HEAD (diffed every push) | [ROLLUP.md](audit/launch-2026-09/ROLLUP.md) · `node scripts/audit-bus.mjs list --blockers` | 138 open, 3 open launch blockers; 227 fixed, 14 retracted, 31 duplicate, 0 wontfix, 19 obsolete |
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 909 | 0 | 9 exempt | 918 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
