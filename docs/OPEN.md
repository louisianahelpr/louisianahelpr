...
- **Queue (this file):** 112 done, 11 partly done (fixed, protection pending), 87 open. Source of truth for work.
...
**Queue: 210 items — 112 done, 11 partly done (fixed, protection pending), 87 open.**
