 ...
 * 20260923182915: (a) 8 functions, (b) the same 8 (14 links).
 *
 * @mutate supabase/migrations/20260923182915_notification_producers_carry_their_subject.sql | '/my-jobs?job=' \|\| rec.id::text, false, rec.id); | '/my-jobs?filter=offered', false, rec.id);
 * @mutate supabase/migrations/20260923182915_notification_producers_carry_their_subject.sql | '/my-posts?job=' \|\| v_locked.id::text, | '/my-posts',
 * @mutate supabase/migrations/20260923182915_notification_producers_carry_their_subject.sql | '/admin?view=fraud&user=' \|\| p_reviewee_id, | '/admin?view=fraud&usr=' \|\| p_reviewee_id,
...
const Q139 = "20260923182915_notification_producers_carry_their_subject.sql";
