...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 218 | 105 | 27 partly | 350 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 218 done, 27 partly done (fixed, protection pending), 105 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 897 | 1 | 9 exempt | 907 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
