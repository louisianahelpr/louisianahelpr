...
- **Queue (this file):** 85 done, 11 partly done (fixed, protection pending), 83 open. Source of truth for work.
...
**Queue: 179 items — 85 done, 11 partly done (fixed, protection pending), 83 open.**
