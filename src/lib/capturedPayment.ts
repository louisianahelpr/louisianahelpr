 ...
 * PaymentIntent is the evidence. Both real capture paths write the PI in the
 * same UPDATE that sets the status (stripe-webhook checkoutSessionCompleted,
 * charge-recurring-visits), so a held-status row with NO PI is a row nobody
