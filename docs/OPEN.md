...
- **Queue (this file):** 72 done, 11 partly done (fixed, protection pending), 77 open. Source of truth for work.
...
**Queue: 160 items — 72 done, 11 partly done (fixed, protection pending), 77 open.**
