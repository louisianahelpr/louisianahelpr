...
- **Queue (this file):** 139 done, 22 partly done (fixed, protection pending), 135 open. Source of truth for work.
...
**Queue: 296 items — 139 done, 22 partly done (fixed, protection pending), 135 open.**
