...
| open work | audit bus findings (open / launch blockers) | **FAIL** | 322 | 39 | — | 429 | HEAD (diffed every push) | [ROLLUP.md](audit/launch-2026-09/ROLLUP.md) · `node scripts/audit-bus.mjs list --blockers` | 39 open, 3 open launch blockers; 322 fixed, 14 retracted, 31 duplicate, 1 wontfix, 22 obsolete |
