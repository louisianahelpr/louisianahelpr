...
- **Queue (this file):** 102 done, 10 partly done (fixed, protection pending), 88 open. Source of truth for work.
...
**Queue: 200 items — 102 done, 10 partly done (fixed, protection pending), 88 open.**
