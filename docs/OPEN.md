...
- **Queue (this file):** 155 done, 29 partly done (fixed, protection pending), 123 open. Source of truth for work.
...
**Queue: 307 items — 155 done, 29 partly done (fixed, protection pending), 123 open.**
