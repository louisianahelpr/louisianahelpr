...
// @mutate src/components/job-card/JobStepCard.tsx | const ownPrimary = claims === 0 && hasRenderable(primary) ? primary : null; | const ownPrimary = hasRenderable(primary) ? primary : null;
