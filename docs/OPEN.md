...
- **Queue (this file):** 123 done, 14 partly done (fixed, protection pending), 82 open. Source of truth for work.
...
**Queue: 219 items — 123 done, 14 partly done (fixed, protection pending), 82 open.**
