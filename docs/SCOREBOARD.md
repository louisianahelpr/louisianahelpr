...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 65 | 82 | 13 partly | 160 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 65 done, 13 partly done (fixed, protection pending), 82 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 755 | 0 | 8 exempt | 763 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
