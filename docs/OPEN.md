...
- **Queue (this file):** 74 done, 11 partly done (fixed, protection pending), 76 open. Source of truth for work.
...
**Queue: 161 items — 74 done, 11 partly done (fixed, protection pending), 76 open.**
