...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 30 | 71 | 4 partly | 105 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 30 done, 4 partly done (fixed, protection pending), 71 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 732 | 0 | 8 exempt | 740 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
