...
- **Queue (this file):** 148 done, 27 partly done (fixed, protection pending), 128 open. Source of truth for work.
...
**Queue: 303 items — 148 done, 27 partly done (fixed, protection pending), 128 open.**
