...
- **Queue (this file):** 121 done, 11 partly done (fixed, protection pending), 84 open. Source of truth for work.
...
**Queue: 216 items — 121 done, 11 partly done (fixed, protection pending), 84 open.**
