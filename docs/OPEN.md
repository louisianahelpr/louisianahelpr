...
- **Queue (this file):** 93 done, 10 partly done (fixed, protection pending), 86 open. Source of truth for work.
...
**Queue: 189 items — 93 done, 10 partly done (fixed, protection pending), 86 open.**
