...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 220 | 103 | 27 partly | 350 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 220 done, 27 partly done (fixed, protection pending), 103 open |
| open work | audit bus findings (open / launch blockers) | **FAIL** | 209 | 161 | — | 429 | HEAD (diffed every push) | [ROLLUP.md](audit/launch-2026-09/ROLLUP.md) · `node scripts/audit-bus.mjs list --blockers` | 161 open, 4 open launch blockers; 209 fixed, 14 retracted, 28 duplicate, 0 wontfix, 17 obsolete |
