...
| open work | audit bus findings (open / launch blockers) | **FAIL** | 305 | 56 | — | 429 | HEAD (diffed every push) | [ROLLUP.md](audit/launch-2026-09/ROLLUP.md) · `node scripts/audit-bus.mjs list --blockers` | 56 open, 3 open launch blockers; 305 fixed, 14 retracted, 31 duplicate, 1 wontfix, 22 obsolete |
