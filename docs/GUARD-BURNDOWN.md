...
|---|---|---|---|---|
| **`src/test/*.test.ts*`** | 545 | **545 — COMPLETE** | 0 | **0** |
| **`src/test/edge/` (money)** | 72 | **72 — COMPLETE** | 0 | **0** |
| **colocated beside components** | 379 | 376 | 0 | **3** |
| **Playwright `e2e/`** | 67 | **58 — COMPLETE** | 9 | **0** |
| **total** | **1063** | **1051 (99%)** | **9** | **3** |

`npm run vacuity` prints the same three numbers on every run:

```
registration: 1051/1063 guards register a mutation (9 exempt with a reason, 0 grandfathered)
```
