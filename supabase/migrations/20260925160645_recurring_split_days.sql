...
-- ── Applications: the claim's takeover of a vacated visit ────────────────
-- Restated from 20260924020956 (newest) with ONE addition, C11: the
-- transaction-local app.series_claim_rpc flag that claim_series_dates sets
-- around the accepted application it writes for a vacated visit it hands over.
