...
- **Queue (this file):** 45 done, 5 partly done (fixed, protection pending), 71 open. Source of truth for work.
...
**Queue: 121 items — 45 done, 5 partly done (fixed, protection pending), 71 open.**
