...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 32 | 71 | 5 partly | 108 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 32 done, 5 partly done (fixed, protection pending), 71 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 734 | 0 | 8 exempt | 742 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
