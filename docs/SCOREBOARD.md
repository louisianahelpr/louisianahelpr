...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 65 | 78 | 11 partly | 154 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 65 done, 11 partly done (fixed, protection pending), 78 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 754 | 0 | 8 exempt | 762 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
