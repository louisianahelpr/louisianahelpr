...
- **Queue (this file):** 158 done, 34 partly done (fixed, protection pending), 116 open. Source of truth for work.
...
**Queue: 308 items — 158 done, 34 partly done (fixed, protection pending), 116 open.**
