...
await ctx.addInitScript(({key,val})=>{
  ...
  try{window.localStorage.setItem("helpr_payouts_enabled_f6cc3ebb-9478-473c-8eb8-62b406f0734f","1");window.localStorage.setItem("helpr_onboarding",JSON.stringify({completed:true,currentStep:0,completedSteps:[]}));}catch{}
  window.__shifts=[];
