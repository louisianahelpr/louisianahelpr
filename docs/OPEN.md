...
- **Queue (this file):** 110 done, 11 partly done (fixed, protection pending), 87 open. Source of truth for work.
...
**Queue: 208 items — 110 done, 11 partly done (fixed, protection pending), 87 open.**
