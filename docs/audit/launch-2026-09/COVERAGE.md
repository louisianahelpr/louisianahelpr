...
Generated from findings.jsonl as of its newest entry: 2026-09-24T07:31:53.501Z

- **Lanes:** 46 total — **38 reported**, 1 ran without filing a report, **7 not started**
- **Findings:** 61 open (3 open launch blockers), 300 fixed, 1 wontfix, 22 obsolete, 14 retracted, 31 duplicate, 429 filed all time — same fold and definitions as ROLLUP.md
...
| 2 | `lh-appsec` | REPORTED | 1 | – | 7 |
| 2 | `lh-authz-rls` | REPORTED | 0 | – | 9 |
| 2 | `lh-design-holes` | REPORTED | 2 | – | 6 |
...
| 3 | `lh-native-bridge` | REPORTED | 7 | **2** | 13 |
...
| 6 | `lh-admin-moderation` | REPORTED | 2 | – | 9 |
...
## Surface coverage — 1038 auditable surfaces, not 46 lanes
