...
**116 files render form controls, across 22 route groups.** Primitives in `src/components/ui/` are excluded. Messy-input coverage: `e2e/prod-audit/messy-input.spec.ts` (PROD, no mocks).
...
| `src/pages/auth/CompleteProfile.tsx` | input×5, textarea×1, checkbox/switch/radio×1 | file, text, tel | 14, 5 | avatar · firstName · lastName · dob · phone · city · zipCode · 70801 |
...
| File | Controls | input types | maxLength | hints |
|---|---|---|---|---|
| `src/hooks/useComboboxKeyboard.ts` | input×1 | search |  |  |
...
| `src/components/job-card/ActivityHeader.tsx` | input×1 | search |  | activity-status-tabs · Search jobs · Close search |
...
| `src/pages/jobs/appliedJobCard/ActiveJobSection.tsx` | textarea×1 |  | 1000 |  |
| `src/pages/jobs/appliedJobCard/DisputedSection.tsx` | textarea×1 |  | 500 |  |
| `src/pages/jobs/appliedJobCard/PendingApplicationSection.tsx` | input×1, textarea×1 | file |  | Edit your message · Remove attachment |
...
| `src/pages/post-job/DirectOfferBanner.tsx` | select×1 |  |  | Cancel direct offer · direct-offer-window |
...
| `src/pages/profile/AutoTip.tsx` | input×2, checkbox/switch/radio×1 | number |  | Automatic tip · auto-tip-amount-label · auto-tip-custom · auto-tip-cap · No maximum · instant-release-heading · instant-release-desc |
| `src/pages/profile/GiftCard.tsx` | input×2, textarea×1 | text, number |  | gift-form · gift-occasion-label · gift-amount-label · gift-custom-amount · gift-amount-help · gift-note |
| `src/pages/profile/giftCards/RecipientPicker.tsx` | input×1 | text |  | Clear selected recipient · Name or email address… · Recipient — name or email |
| `src/pages/profile/HomeHistory.tsx` | date/calendar×1 |  |  |  |
| `src/pages/profile/petProfiles/PetForm.tsx` | input×9, textarea×3 | text, number, tel |  | pet-name · pet-name-error · pet-breed · Lab mix · pet-breed-suggestions · pet-age · pet-age-error · pet-weight |
| `src/pages/profile/strSettings/AddCalendarForm.tsx` | input×5, checkbox/switch/radio×1 | url, text, number |  | ical-url · ical-url-error · str-property-name · e.g. Lakehouse · str-property-address · e.g. New Orleans, LA · str-auto-create-cleaning-label · str-auto-create-cleaning |
| `src/pages/profile/WorkRecord.tsx` | date/calendar×1 |  |  |  |

## /reset-password

| File | Controls | input types | maxLength | hints |
|---|---|---|---|---|
| `src/pages/auth/ResetPassword.tsx` | input×2 | text |  | password · confirm · reset-password-error |
...
| `src/pages/info/Support.tsx` | input×3, textarea×1, select×1 | text, email |  | support-name · name · support-name-error · support-email · email · support-email-error · support-topic · Choose a topic |

## /user/:userId

| File | Controls | input types | maxLength | hints |
|---|---|---|---|---|
| `src/pages/user/ReviewsSection.tsx` | textarea×1 |  | 500 | profile-review-card · Report this review · Write a public response |
