...
- **Queue (this file):** 95 done, 10 partly done (fixed, protection pending), 88 open. Source of truth for work.
...
**Queue: 193 items — 95 done, 10 partly done (fixed, protection pending), 88 open.**
