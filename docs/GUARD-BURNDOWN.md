...
|---|---|---|---|---|
| **`src/test/*.test.ts*`** | 623 | **623 — COMPLETE** | 0 | **0** |
| **`src/test/edge/` (money)** | 76 | **76 — COMPLETE** | 0 | **0** |
| **colocated beside components** | 384 | **384 — COMPLETE** | 0 | **0** |
| **Playwright `e2e/`** | 77 | **67 — COMPLETE** | 10 | **0** |
| **total** | **1160** | **1150 (99%)** | **10** | **0** |

`npm run vacuity` prints the same three numbers on every run:

```
registration: 1150/1160 guards register a mutation (10 exempt with a reason, 0 grandfathered)
```
