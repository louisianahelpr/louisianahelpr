...
// @mutate src/pages/post-job/jobSubmitHelpers.ts | ? (seriesDates[seriesDates.length - 1] ?? (recurrenceEndDate \|\| null)) | ? (recurrenceEndDate \|\| null)
...
// @mutate src/pages/post-job/jobSubmitHelpers.ts | ...(isRecurring && seriesDays.length > 0 | ...(isRecurring
...
// @mutate src/pages/post-job/useJobSubmit.ts | saveCardForFuture: saveCardForFuture \|\| isRecurring | saveCardForFuture: saveCardForFuture
