...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 167 | 105 | 36 partly | 308 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 167 done, 36 partly done (fixed, protection pending), 105 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 864 | 1 | 9 exempt | 874 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
