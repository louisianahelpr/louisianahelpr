...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 159 | 115 | 34 partly | 308 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 159 done, 34 partly done (fixed, protection pending), 115 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 852 | 1 | 9 exempt | 862 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
