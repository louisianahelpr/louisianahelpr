...
- **Queue (this file):** 148 done, 30 partly done (fixed, protection pending), 124 open. Source of truth for work.
...
**Queue: 302 items — 148 done, 30 partly done (fixed, protection pending), 124 open.**
