// @mutate src/pages/jobs/appliedJobCard/HelperTrackerPanel.tsx | (jobDayStart(job.date_needed).getTime() - Date.now()) | (new Date(job.date_needed + "T00:00:00").getTime() - Date.now())
