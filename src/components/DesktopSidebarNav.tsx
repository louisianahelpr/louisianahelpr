      ...
      {!isPendingApproval && (
        <div className="px-4 pb-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-full px-4 py-3 font-display italic font-semibold text-[0.95rem] transition-transform active:scale-[0.98]"
            style={{
              background:
