...
- **Queue (this file):** 168 done, 37 partly done (fixed, protection pending), 104 open. Source of truth for work.
...
**Queue: 311 items — 169 done, 37 partly done (fixed, protection pending), 105 open.**
