...
- **Queue (this file):** 93 done, 10 partly done (fixed, protection pending), 87 open. Source of truth for work.
...
**Queue: 190 items — 93 done, 10 partly done (fixed, protection pending), 87 open.**
