...
**Every row states its UNIT.** Overlays are counted as instances (152) not
files (118); emails as exported templates (19) not files (15); admin as files
...
| Overlay surfaces | **instance** | 152 |
| — of which hand-rolled, no dialog primitive | instance | 9 (across 8 files) |
| Toast messages | **call site** | 558 (across 144 files) |
...
| **Copy surfaces** (strings a person may read) | mixed | **595** |
| **Total auditable surface** | mixed | **1044** |
...
| `src/components/schedule/ScheduleChangeControl.tsx` | 1 | BrandConfirmDialog |
| `src/components/series/EndSeriesControl.tsx` | 1 | BrandConfirmDialog |
| `src/components/series/SeriesDatesPanel.tsx` | 1 | BrandConfirmDialog |
