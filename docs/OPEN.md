...
- **Queue (this file):** 153 done, 26 partly done (fixed, protection pending), 127 open. Source of truth for work.
...
**Queue: 306 items — 153 done, 26 partly done (fixed, protection pending), 127 open.**
