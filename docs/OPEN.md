...
- **Queue (this file):** 133 done, 16 partly done (fixed, protection pending), 134 open. Source of truth for work.
...
**Queue: 283 items — 133 done, 16 partly done (fixed, protection pending), 134 open.**
