...
- **Queue (this file):** 108 done, 11 partly done (fixed, protection pending), 86 open. Source of truth for work.
...
**Queue: 205 items — 108 done, 11 partly done (fixed, protection pending), 86 open.**
