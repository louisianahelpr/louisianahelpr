...
describe("the poster's collapsed card announces the dispute", () => {
  ...
  it("a collapsed helper card still announces an open dispute, which is the bar being matched", async () => {
    const { render } = await import("@testing-library/react");
    const { JobStatusStrip } = await import("../../../components/job-card/JobStatusStrip");
    const { helperStatusLine } = await import("../../../components/job-card/jobStatusLine");
...
// @mutate src/pages/jobs/appliedJobCard/helperDisputeCopy.ts | canRespond: respondableStatus && !iOpenedIt, | canRespond: respondableStatus,
