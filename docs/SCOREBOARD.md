...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 253 | 112 | 35 partly | 400 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 253 done, 35 partly done (fixed, protection pending), 112 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 1043 | 0 | 9 exempt | 1052 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
