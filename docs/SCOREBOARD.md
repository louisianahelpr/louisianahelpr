...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 109 | 85 | 12 partly | 206 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 109 done, 12 partly done (fixed, protection pending), 85 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 780 | 1 | 8 exempt | 789 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
