...
const DashboardHeader = ({ title, onMenuClick }: DashboardHeaderProps) => {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 glass border-b border-border/30 bg-background" style={{ paddingTop: "env(safe-area-inset-top, 0px)", marginTop: "calc(-1 * env(safe-area-inset-top, 0px))" }}>
