...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 91 | 86 | 10 partly | 187 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 91 done, 10 partly done (fixed, protection pending), 86 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 767 | 0 | 8 exempt | 775 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
