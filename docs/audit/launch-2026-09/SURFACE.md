...
**Every row states its UNIT.** Overlays are counted as instances (150) not
files (116); emails as exported templates (19) not files (15); admin as files
...
| Toast messages | **call site** | 544 (across 142 files) |
...
| Admin components (components/admin + pages/Admin*) | **file** | 108 |
| Email templates | **exported template** | 19 |
| Notification types (defined in notification_type_pref_map) | type | 18 |
| **Navigable surfaces** (places a person can stand) | mixed | **452** |
| **Copy surfaces** (strings a person may read) | mixed | **581** |
