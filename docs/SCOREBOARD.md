...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 20 | 64 | 5 partly | 89 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 20 done, 5 partly done (fixed, protection pending), 64 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 726 | 0 | 8 exempt | 734 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
