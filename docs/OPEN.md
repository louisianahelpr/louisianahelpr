...
- **Queue (this file):** 99 done, 10 partly done (fixed, protection pending), 87 open. Source of truth for work.
...
**Queue: 196 items — 99 done, 10 partly done (fixed, protection pending), 87 open.**
