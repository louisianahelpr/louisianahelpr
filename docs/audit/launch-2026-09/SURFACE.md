...
files (116); emails as exported templates (20) not files (15); admin as files
...
| **Copy surfaces** (strings a person may read) | mixed | **578** |
| **Total auditable surface** | mixed | **1027** |
