...
- **Queue (this file):** 68 done, 11 partly done (fixed, protection pending), 81 open. Source of truth for work.
...
**Queue: 160 items — 68 done, 11 partly done (fixed, protection pending), 81 open.**
