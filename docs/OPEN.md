...
- **Queue (this file):** 167 done, 36 partly done (fixed, protection pending), 105 open. Source of truth for work.
...
**Queue: 308 items — 168 done, 37 partly done (fixed, protection pending), 103 open.**
