...
| open work | audit bus findings (open / launch blockers) | **FAIL** | 208 | 162 | — | 429 | HEAD (diffed every push) | [ROLLUP.md](audit/launch-2026-09/ROLLUP.md) · `node scripts/audit-bus.mjs list --blockers` | 162 open, 5 open launch blockers; 208 fixed, 14 retracted, 28 duplicate, 0 wontfix, 17 obsolete |
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 898 | 2 | 9 exempt | 909 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
