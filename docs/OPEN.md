...
- **Queue (this file):** 33 done, 5 partly done (fixed, protection pending), 71 open. Source of truth for work.
...
**Queue: 109 items — 33 done, 5 partly done (fixed, protection pending), 71 open.**
