...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 163 | 110 | 35 partly | 308 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 163 done, 35 partly done (fixed, protection pending), 110 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **FAIL** | 859 | 1 | 9 exempt | 869 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
