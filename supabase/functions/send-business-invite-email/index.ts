...
<body style="background:#FAFAF8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;margin:0;padding:24px;color:hsl(160, 10%, 12%);">
  <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:14px;padding:32px 28px;border:1px solid hsl(0,0%,92%);">
    ...
    <p style="font-size:15px;line-height:1.6;margin:0 0 16px;color:hsl(160,6%,40%);">
      ${inviterName} added you to the <strong style="color:hsl(160,10%,12%);">${businessName}</strong> team on Helpr. Once you sign up, you'll be able to post and manage jobs on behalf of the business.
    </p>
    <p style="font-size:15px;line-height:1.6;margin:0 0 24px;color:hsl(160,6%,40%);">
      Sign up using <strong>${recipientEmail}</strong> — that's the address that matches your invite.
    </p>
    <a href="${signupUrl}" style="display:inline-block;background:hsl(158, 45%, 42%);color:#fff;text-decoration:none;padding:14px 28px;border-radius:12px;font-weight:600;font-size:15px;">Sign up + join team</a>
