...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 75 | 75 | 11 partly | 161 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 75 done, 11 partly done (fixed, protection pending), 75 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 758 | 0 | 8 exempt | 766 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
