          ...
          <div className="relative">
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex min-h-12 w-full items-center justify-center gap-2.5 rounded-xl bg-[#0d4a8f] px-5 py-2.5 text-white shadow-[0_8px_24px_-8px_rgba(13,74,143,0.5)] ring-1 ring-white/10 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-[#0a3a72] hover:shadow-[0_16px_36px_-10px_rgba(13,74,143,0.6)] sm:w-auto"
