...
export const CancellationDialog = ({ jobId, jobTitle, jobDate, jobBudget, userId, hasHelper, helperName, open, onClose, onCancelled }: Omit<CancellationDialogProps, "helperId">) => {
