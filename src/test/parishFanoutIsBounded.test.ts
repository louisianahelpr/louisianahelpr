 ...
 *
 * @mutate supabase/migrations/20260924220318_rename_tab_addresses.sql | )  -- N-007 once per job | ) OR true  -- N-007 once per job
 * @mutate supabase/migrations/20260924220318_rename_tab_addresses.sql | ) < 10  -- N-007 hourly cap | ) >= 0  -- N-007 hourly cap
 */
