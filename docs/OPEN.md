...
- **Queue (this file):** 155 done, 32 partly done (fixed, protection pending), 121 open. Source of truth for work.
...
**Queue: 308 items — 155 done, 32 partly done (fixed, protection pending), 121 open.**
