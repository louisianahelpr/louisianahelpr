...
- **Queue (this file):** 143 done, 22 partly done (fixed, protection pending), 130 open. Source of truth for work.
...
**Queue: 295 items — 143 done, 22 partly done (fixed, protection pending), 130 open.**
