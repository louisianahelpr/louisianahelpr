...
- **Queue (this file):** 147 done, 31 partly done (fixed, protection pending), 125 open. Source of truth for work.
...
**Queue: 303 items — 147 done, 31 partly done (fixed, protection pending), 125 open.**
