...
- **Queue (this file):** 153 done, 26 partly done (fixed, protection pending), 128 open. Source of truth for work.
...
**Queue: 307 items — 153 done, 26 partly done (fixed, protection pending), 128 open.**
