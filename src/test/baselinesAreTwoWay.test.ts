...
const OUT_OF_SCOPE: Record<string, string> = {
  ...
  "src/pages/completeProfile/constants.ts::ALLOWED_IMAGE_TYPES": "app upload MIME types",
  "src/pages/giftCards/StatusPill.tsx::UNKNOWN": "app display fallback (name contains KNOWN)",
  "src/pages/signup/signupHelpers.ts::ALLOWED_IMAGE_TYPES": "app upload MIME types",
