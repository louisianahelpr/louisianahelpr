...
|---|---|---|---|---|---|---|---|---|---|
| open work | OPEN.md queue (done / partly / open) | **WARN** | 26 | 67 | 4 partly | 97 | HEAD (diffed every push) | [docs/OPEN.md](OPEN.md) · scripts/queue-count.mjs | 26 done, 4 partly done (fixed, protection pending), 67 open |
...
| guards | vacuity: guards proven able to fail / exempt / owed | **PASS** | 731 | 0 | 8 exempt | 739 | HEAD (diffed every push) | [GUARD-BURNDOWN.md](GUARD-BURNDOWN.md) · `npm run vacuity` | registered @mutate per guard; whether each mutation is KILLED is the full-sweep row below |
