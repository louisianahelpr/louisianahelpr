...
- **Queue (this file):** 158 done, 32 partly done (fixed, protection pending), 118 open. Source of truth for work.
...
**Queue: 308 items — 158 done, 32 partly done (fixed, protection pending), 118 open.**
