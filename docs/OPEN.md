...
- **Queue (this file):** 35 done, 5 partly done (fixed, protection pending), 72 open. Source of truth for work.
...
**Queue: 112 items — 35 done, 5 partly done (fixed, protection pending), 72 open.**
