 ...
 *
 * @mutate supabase/migrations/20260926034740_route_probe_close_rule_hardening.sql |   ELSIF p_source = 'cron-http-untagged' AND v_job IS NOT NULL THEN |   ELSIF p_source = 'cron-http-untagged-gone' AND v_job IS NOT NULL THEN
 * @mutate supabase/migrations/20260926034740_route_probe_close_rule_hardening.sql |          AND j.active\n |          AND true\n
 * @mutate supabase/migrations/20260926034740_route_probe_close_rule_hardening.sql |          AND j.command NOT LIKE '%cron_http_tag(%'); |          AND true);
 *
