...
- **Queue (this file):** 36 done, 5 partly done (fixed, protection pending), 71 open. Source of truth for work.
...
**Queue: 112 items — 36 done, 5 partly done (fixed, protection pending), 71 open.**
