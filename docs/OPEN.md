...
- **Queue (this file):** 133 done, 15 partly done (fixed, protection pending), 134 open. Source of truth for work.
...
**Queue: 282 items — 133 done, 15 partly done (fixed, protection pending), 134 open.**
