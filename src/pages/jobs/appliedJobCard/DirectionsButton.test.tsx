...
// @mutate src/pages/jobs/appliedJobCard/DirectionsButton.tsx | if (!href) return null;
// @mutate src/pages/jobs/appliedJobCard/DirectionsButton.tsx | onClick={(e) => e.stopPropagation()}
