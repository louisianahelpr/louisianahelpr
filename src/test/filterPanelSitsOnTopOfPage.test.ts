 ...
 *
 * @mutate src/components/ui/anchoredPanel.tsx | background: "hsl(var(--popover))", | background: "hsl(var(--background))",
...
describe("the phone filter panel sits on top of the page", () => {
