...
// @mutate supabase/migrations/20260923123701_null_argument_never_allows.sql | '^' \|\| p_user_id::text \|\| '/credentials/' \|\| p_kind | '/credentials/' \|\| p_kind
// @mutate supabase/migrations/20260923123701_null_argument_never_allows.sql | p_kind \|\| '-[0-9]{13}\.([Pp][Dd][Ff]\|[Pp][Nn][Gg]\|[Jj][Pp][Ee]?[Gg]\|[Ww][Ee][Bb][Pp]\|[Hh][Ee][Ii][Cc])$') THEN | p_kind \|\| '-[0-9]{13}\.([Pp][Dd][Ff]\|[Pp][Nn][Gg]\|[Jj][Pp][Ee]?[Gg]\|[Ww][Ee][Bb][Pp]\|[Hh][Ee][Ii][Cc])') THEN
// @mutate supabase/migrations/20260923123701_null_argument_never_allows.sql | p_kind \|\| '-[0-9]{13}\.([Pp][Dd][Ff]\|[Pp][Nn][Gg]\|[Jj][Pp][Ee]?[Gg]\|[Ww][Ee][Bb][Pp]\|[Hh][Ee][Ii][Cc])$') THEN | p_kind \|\| '-[0-9]{13}\.([Pp][Dd][Ff]\|[Pp][Nn][Gg]\|[Jj][Pp][Ee]?[Gg]\|[Ww][Ee][Bb][Pp]\|[Hh][Tt][Mm][Ll]\|[Hh][Ee][Ii][Cc])$') THEN
// @mutate supabase/migrations/20260923123701_null_argument_never_allows.sql | WHERE o.bucket_id = 'user-documents' AND o.name = p_path\n  );\nEND;\n$fn$;\n\nREVOKE ALL ON FUNCTION public.credential_document_path_ok | WHERE o.bucket_id = 'user-documents'\n  );\nEND;\n$fn$;\n\nREVOKE ALL ON FUNCTION public.credential_document_path_ok
...
// @mutate supabase/migrations/20260923123701_null_argument_never_allows.sql | credential_document_path_ok(uuid, text, text) FROM PUBLIC, anon, authenticated; | credential_document_path_ok(uuid, text, text) FROM PUBLIC, anon;
