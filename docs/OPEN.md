...
- **Queue (this file):** 66 done, 13 partly done (fixed, protection pending), 81 open. Source of truth for work.
...
**Queue: 160 items — 66 done, 13 partly done (fixed, protection pending), 81 open.**
