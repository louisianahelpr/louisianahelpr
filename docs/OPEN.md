...
- **Queue (this file):** 148 done, 27 partly done (fixed, protection pending), 127 open. Source of truth for work.
...
**Queue: 302 items — 148 done, 27 partly done (fixed, protection pending), 127 open.**
