...
- **Queue (this file):** 121 done, 11 partly done (fixed, protection pending), 87 open. Source of truth for work.
...
**Queue: 219 items — 121 done, 11 partly done (fixed, protection pending), 87 open.**
