...
- **Queue (this file):** 83 done, 11 partly done (fixed, protection pending), 81 open. Source of truth for work.
...
**Queue: 175 items — 83 done, 11 partly done (fixed, protection pending), 81 open.**
