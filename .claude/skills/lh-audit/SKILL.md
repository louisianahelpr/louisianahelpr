---
name: lh-audit
description: Louisiana Helpr audit standard. Invoke on ANY audit, improvement, or per-screen check — /audit, /improve, "run the LH audit", or ad-hoc "look at this page/screen/route/component". Defines the three lenses (cohesion, product sense, trust), the sweep→fix→verify method, per-screen dimension checklist, severity tiers, completeness bar, and review tooling. Every rule is mandatory.
---
