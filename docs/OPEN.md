...
- **Queue (this file):** 126 done, 14 partly done (fixed, protection pending), 125 open. Source of truth for work.
...
**Queue: 265 items — 126 done, 14 partly done (fixed, protection pending), 125 open.**
